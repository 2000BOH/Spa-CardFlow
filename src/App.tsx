  ...
  if (isDesktop) {
    return (
      <div className="min-h-screen bg-white">
        ...
        <main className="cb-page px-8 py-12 grid grid-cols-[minmax(0,1fr)_396px] gap-8 items-start">
          <ExpenseList
            expenses={expenses}
        ...
        <footer className="border-t border-line">
          <div className="cb-page px-8 py-7 flex items-center justify-between gap-4 text-[14px] text-muted">
